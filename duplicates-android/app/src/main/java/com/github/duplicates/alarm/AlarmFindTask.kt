 ...
 * @author moshe.w
 */
class AlarmFindTask(context: Context, listener: DuplicateTaskListener<AlarmItem, DuplicateTask<AlarmItem, Any, Any, List<AlarmItem>>>) : DuplicateFindTask<AlarmItem, AlarmViewHolder>(context, listener) {
